...
CORRECCION APLICADA:
- Configurar GitHub ahora abre una ventana interna del sistema, no prompts del navegador.
- Incluye boton para probar token.
- Mantiene cabeceras oficiales en data/registros.csv y data/registros.json.
